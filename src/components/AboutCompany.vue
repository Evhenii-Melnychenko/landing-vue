...
.about-our-company {
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="20" cy="20" r="1.5" fill="rgba(0,87,27,0.08)"/><circle cx="80" cy="80" r="1.5" fill="rgba(0,87,27,0.08)"/></svg>') repeat;
    opacity: 0.6;
  }
